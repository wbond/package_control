...
class GitHubClientTests(unittest.TestCase):
    ...
    def test_github_client_branch_downloads(self):
        ...
        self.assertEqual(
            [{
                ...
                LAST_COMMIT_VERSION,
                'url':
                'https://codeload.github.com/packagecontrol-test/package_control-tester/zip/master'
            }],
    ...
    def test_github_client_tags_downloads(self):
        ...
        self.assertEqual([{
            ...
            '1.0.1',
            'url':
            'https://codeload.github.com/packagecontrol-test/package_control-tester/zip/1.0.1'
        }, {
            'date':
            '2014-11-12 15:14:23',
            'version':
            '1.0.1-beta',
            'url':
            'https://codeload.github.com/packagecontrol-test/package_control-tester/zip/1.0.1-beta'
        }, {
            'date':
            '2014-11-12 15:14:13',
            'version':
            '1.0.0',
            'url':
            'https://codeload.github.com/packagecontrol-test/package_control-tester/zip/1.0.0'
        }, {
            'date':
            '2014-11-12 02:02:22',
            'version':
            '0.9.0',
            'url':
            'https://codeload.github.com/packagecontrol-test/package_control-tester/zip/0.9.0'
        }],
                         client.download_info(
...
class BitBucketClientTests(unittest.TestCase):
    ...
    def bitbucket_settings(self):
        return {'debug': True, 'cache': HttpCache(604800)}
        ...
        self.assertEqual(
            {
                ...
                'author': 'wbond',
                'readme':
                'https://bitbucket.org/wbond/package_control-tester/raw/master/readme.md',
                'issues':
                'https://bitbucket.org/wbond/package_control-tester/issues',
                'donate': None
            },
            client.repo_info(
                'https://bitbucket.org/wbond/package_control-tester'))
    ...
    def test_bitbucket_client_branch_downloads(self):
        ...
        self.assertEqual([{
            ...
            LAST_COMMIT_VERSION,
            'url':
            'https://bitbucket.org/wbond/package_control-tester/get/master.zip'
        }],
                         client.download_info(
                             'https://bitbucket.org/wbond/package_control-tester'
                         ))
    ...
    def test_bitbucket_client_tags_downloads(self):
        ...
        self.assertEqual([{
            ...
            '1.0.1',
            'url':
            'https://bitbucket.org/wbond/package_control-tester/get/1.0.1.zip'
        }, {
            'date':
            '2014-11-12 15:14:23',
            'version':
            '1.0.1-beta',
            'url':
            'https://bitbucket.org/wbond/package_control-tester/get/1.0.1-beta.zip'
        }, {
            'date':
            '2014-11-12 15:14:13',
            'version':
            '1.0.0',
            'url':
            'https://bitbucket.org/wbond/package_control-tester/get/1.0.0.zip'
        }, {
            'date':
            '2014-11-12 02:02:22',
            'version':
            '0.9.0',
            'url':
            'https://bitbucket.org/wbond/package_control-tester/get/0.9.0.zip'
        }],
                         client.download_info(
    ...
    def test_bitbucket_client_tags_prefix_downloads(self):
        ...
        self.assertEqual(
            [{
                ...
                '1.0.2',
                'url':
                'https://bitbucket.org/wbond/package_control-tester/get/win-1.0.2.zip'
            }],
            client.download_info(
                'https://bitbucket.org/wbond/package_control-tester#tags',
                'win-'))
