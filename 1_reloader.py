...
mods_load_order = [
    ...
    '.deps.oscrypto._osx._common_crypto_ctypes',
    '.deps.oscrypto._osx._common_crypto',
    '.deps.oscrypto._osx._security_ctypes',
    '.deps.oscrypto._osx._security',
    '.deps.oscrypto._osx.util',
    ...
    '.deps.oscrypto._openssl',
    '.deps.oscrypto._linux_bsd.trust_list',
    '.deps.oscrypto._linux_bsd',
    '.deps.oscrypto._osx.trust_list',
    '.deps.oscrypto._osx.asymmetric',
    '.deps.oscrypto._osx.symmetric',
    '.deps.oscrypto._osx.tls',
    '.deps.oscrypto._osx',
